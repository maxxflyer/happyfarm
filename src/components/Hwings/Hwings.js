...
class Hwings extends React.Component {
    constructor(props) {
        super(props)
        console.log("Hwings ------------")
        console.log(props)
      ...
      layoutBack = () => {
        ...
        console.log("LBACK> ",'[["Hwings"],['+tL+this.selectionL+','+tC+this.selectionC+','+tR+this.selectionR+']]')
        this.props.layoutBack('[["Hwings"],['+tL+this.selectionL+','+tC+this.selectionC+','+tR+this.selectionR+']]')
      } 
