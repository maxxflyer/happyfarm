        ...
        <div id="lips" opacity="1" >
            ...
            <div id="lips_menu">
                ...
                <div><a className="lips_menu_link lips_dir_button float_right" href="" target="_blank">TWITTER<br></br><img className="lips_dir_icon" src="https://i.imgur.com/WCPB544.png"/></a></div>
                  <div><a className="lips_menu_link lips_dir_button float_right" href="https://discord.gg/F3Cqksx" target="_blank">DISCORD<br></br><img className="lips_dir_icon" src="https://imgur.com/29798bab-caa6-4140-a883-a3cb642fdc84"/></a></div>
                </div>
            </div>
        </div>
        );
